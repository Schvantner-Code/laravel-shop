...
<div class="tocify-wrapper">
    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="admin-management">
                    <a href="#admin-management">Admin Management</a>
                                    ...
                                    <ul id="tocify-subheader-admin-management" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="admin-management-GETapi-admin-orders">
                                <a href="#admin-management-GETapi-admin-orders">List all orders</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="admin-management-PATCHapi-admin-orders--order_id--status">
                                <a href="#admin-management-PATCHapi-admin-orders--order_id--status">Update Order Status</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="admin-management-GETapi-admin-categories">
                                <a href="#admin-management-GETapi-admin-categories">GET api/admin/categories</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="admin-management-POSTapi-admin-categories">
                                <a href="#admin-management-POSTapi-admin-categories">POST api/admin/categories</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="admin-management-PUTapi-admin-categories--category_id-">
                                <a href="#admin-management-PUTapi-admin-categories--category_id-">PUT api/admin/categories/{category_id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="admin-management-DELETEapi-admin-categories--category_id-">
                                <a href="#admin-management-DELETEapi-admin-categories--category_id-">DELETE api/admin/categories/{category_id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="admin-management-POSTapi-admin-categories--id--restore">
                                <a href="#admin-management-POSTapi-admin-categories--id--restore">Restore a deleted category</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="admin-management-GETapi-admin-products">
                                <a href="#admin-management-GETapi-admin-products">List Products (Admin)</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="admin-management-POSTapi-admin-products">
                                <a href="#admin-management-POSTapi-admin-products">POST api/admin/products</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="admin-management-PUTapi-admin-products--product_id-">
                                <a href="#admin-management-PUTapi-admin-products--product_id-">PUT api/admin/products/{product_id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="admin-management-DELETEapi-admin-products--product_id-">
                                <a href="#admin-management-DELETEapi-admin-products--product_id-">DELETE api/admin/products/{product_id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="admin-management-POSTapi-admin-products--id--restore">
                                <a href="#admin-management-POSTapi-admin-products--id--restore">Restore a deleted product</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="authentication">
                    ...
                    <ul id="tocify-header-products-categories-public" class="tocify-header">
                <li class="tocify-item level-1" data-unique="products-categories-public">
                    <a href="#products-categories-public">Products & Categories (Public)</a>
                </li>
                                    <ul id="tocify-subheader-products-categories-public" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="products-categories-public-GETapi-categories">
                                <a href="#products-categories-public-GETapi-categories">List all categories</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="products-categories-public-GETapi-products">
                                <a href="#products-categories-public-GETapi-products">List all products</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="products-categories-public-GETapi-products--id-">
                                <a href="#products-categories-public-GETapi-products--id-">Get product details</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="user-orders">
                    <a href="#user-orders">User Orders</a>
                                    ...
                                    <ul id="tocify-subheader-user-orders" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="user-orders-GETapi-orders">
                                <a href="#user-orders-GETapi-orders">List my orders</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="user-orders-POSTapi-orders">
                                <a href="#user-orders-POSTapi-orders">Create a new order (Checkout)</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>You can retrieve your token by using the Login endpoint.</p>
    ...
    <p>Endpoints for store administrators</p>

                                <h2 id="admin-management-GETapi-admin-orders">List all orders</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Filter by user, product, or date. Sort by price or date.</p>
...
<div class="bash-example">
    ...
    --get "http://localhost/api/admin/orders?user_id=16&amp;product_id=16&amp;sort_by=created_at&amp;sort_dir=desc" \
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               step="any"               name="user_id"                data-endpoint="GETapi-admin-orders"
               value="16"
               data-component="query">
    <br>
<p>Filter by Customer ID. Example: <code>16</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="product_id"                data-endpoint="GETapi-admin-orders"
               value="16"
               data-component="query">
    <br>
<p>Filter by Product ID inside the order. Example: <code>16</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="sort_by"                data-endpoint="GETapi-admin-orders"
               value="created_at"
               data-component="query">
    <br>
<p>Sort by 'total_price' or 'created_at'. Example: <code>created_at</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="sort_dir"                data-endpoint="GETapi-admin-orders"
               value="desc"
               data-component="query">
    <br>
<p>Sort direction 'asc' or 'desc'. Example: <code>desc</code></p>
                    ...
                    <h2 id="admin-management-PATCHapi-admin-orders--order_id--status">Update Order Status</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Transition the order to a new status (e.g. pending -&gt; paid).</p>
...
<div class="bash-example">
    ...
    "http://localhost/api/admin/orders/2/status" \
    --header "Authorization: Bearer {YOUR_AUTH_TOKEN}" \
    --header "Content-Type: application/json" \
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The new status (paid, shipped, completed, cancelled). Example: <code>paid</code></p>
        </div>
        </form>

                    <h2 id="admin-management-GETapi-admin-categories">GET api/admin/categories</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/admin/categories?scope=all&amp;per_page=10&amp;page=1" \
    --header "Authorization: Bearer {YOUR_AUTH_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="scope"                data-endpoint="GETapi-admin-categories"
               value="all"
               data-component="query">
    <br>
<p>Filter list: 'active' (default), 'trashed', or 'all'. Example: <code>all</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<p>The page number. Example: <code>1</code></p>
                    ...
                    <h2 id="admin-management-POSTapi-admin-categories">POST api/admin/categories</h2>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="name.en"                data-endpoint="POSTapi-admin-categories"
               value="b"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>b</code></p>
                                                                ...
                                                                <div style="margin-left: 14px; clear: unset;">
                        <b style="line-height: 2;"><code>sk</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="name.sk"                data-endpoint="POSTapi-admin-categories"
               value="n"
               data-component="body">
    <br>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Unique URL identifier. Example: <code>notebooks</code></p>
        </div>
        </form>

                    <h2 id="admin-management-PUTapi-admin-categories--category_id-">PUT api/admin/categories/{category_id}</h2>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="name.en"                data-endpoint="PUTapi-admin-categories--category_id-"
               value="b"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>b</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="name.sk"                data-endpoint="PUTapi-admin-categories--category_id-"
               value="n"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>n</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="slug"                data-endpoint="PUTapi-admin-categories--category_id-"
               value=""
               data-component="body">
    <br>
                    ...
                    <h2 id="admin-management-DELETEapi-admin-categories--category_id-">DELETE api/admin/categories/{category_id}</h2>
...
<p>The ID of the category. Example: <code>1</code></p>
                    ...
                    <h2 id="admin-management-POSTapi-admin-categories--id--restore">Restore a deleted category</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost/api/admin/categories/1/restore" \
    --header "Authorization: Bearer {YOUR_AUTH_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-admin-categories--id--restore"
               value="Bearer {YOUR_AUTH_TOKEN}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_TOKEN}</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="id"                data-endpoint="POSTapi-admin-categories--id--restore"
               value="1"
               data-component="url">
    <br>
<p>The ID of the category. Example: <code>1</code></p>
                    ...
                    <h2 id="admin-management-GETapi-admin-products">List Products (Admin)</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>View all products, including inactive or deleted ones.</p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/admin/products?scope=all&amp;per_page=10&amp;page=1" \
    --header "Authorization: Bearer {YOUR_AUTH_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="scope"                data-endpoint="GETapi-admin-products"
               value="all"
               data-component="query">
    <br>
<p>Filter list: 'active' (default), 'trashed', or 'all'. Example: <code>all</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="page"                data-endpoint="GETapi-admin-products"
               value="1"
               data-component="query">
    <br>
<p>The page number. Example: <code>1</code></p>
                    ...
                    <h2 id="admin-management-POSTapi-admin-products">POST api/admin/products</h2>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="name.en"                data-endpoint="POSTapi-admin-products"
               value="b"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>b</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="name.sk"                data-endpoint="POSTapi-admin-products"
               value="n"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>n</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="description.en"                data-endpoint="POSTapi-admin-products"
               value="architecto"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="description.sk"                data-endpoint="POSTapi-admin-products"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Price in cents. Example: <code>1250</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<p>Example: <code>true</code></p>
                    ...
                    <h2 id="admin-management-PUTapi-admin-products--product_id-">PUT api/admin/products/{product_id}</h2>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="PUTapi-admin-products--product_id-"
               value="Bearer {YOUR_AUTH_TOKEN}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_TOKEN}</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="category_id"                data-endpoint="PUTapi-admin-products--product_id-"
               value="1"
               data-component="body">
    <br>
<p>Example: <code>1</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="name.en"                data-endpoint="PUTapi-admin-products--product_id-"
               value="b"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>b</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="name.sk"                data-endpoint="PUTapi-admin-products--product_id-"
               value="n"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>n</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="description.en"                data-endpoint="PUTapi-admin-products--product_id-"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="description.sk"                data-endpoint="PUTapi-admin-products--product_id-"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="price"                data-endpoint="PUTapi-admin-products--product_id-"
               value="1250"
               data-component="body">
    <br>
<p>Price in cents. Example: <code>1250</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <label data-endpoint="PUTapi-admin-products--product_id-" style="display: none">
            <input type="radio" name="is_active"
                   value="true"
                   data-endpoint="PUTapi-admin-products--product_id-"
                   data-component="body"             >
            <code>true</code>
        </label>
        <label data-endpoint="PUTapi-admin-products--product_id-" style="display: none">
...
<p>Example: <code>false</code></p>
                    ...
                    <h2 id="admin-management-DELETEapi-admin-products--product_id-">DELETE api/admin/products/{product_id}</h2>
...
<p>The ID of the product. Example: <code>1</code></p>
                    ...
                    <h2 id="admin-management-POSTapi-admin-products--id--restore">Restore a deleted product</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost/api/admin/products/1/restore" \
    --header "Authorization: Bearer {YOUR_AUTH_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="id"                data-endpoint="POSTapi-admin-products--id--restore"
               value="1"
               data-component="url">
    <br>
<p>The ID of the product. Example: <code>1</code></p>
    ...
    <p>APIs for managing user registration and login.</p>
...
<p>Creates a new customer account and returns an access token.</p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The full name of the user. Example: <code>John Smith</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>A unique email address. Example: <code>johnsmith@example.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be at least 8 characters long Example: <code>secret123</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<p>Example: <code>application/json</code></p>
                ...
                <h1 id="products-categories-public">Products & Categories (Public)</h1>

    

                                <h2 id="products-categories-public-GETapi-categories">List all categories</h2>

<p>
</p>

<p>Returns a paginated list of categories. Supports searching by name.</p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/categories?search=notebooks&amp;per_page=10&amp;page=1" \
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="query">
    <br>
<p>Search category name. Example: <code>notebooks</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>per_page</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
...
<p>The page number. Example: <code>1</code></p>
                    ...
                    <h2 id="products-categories-public-GETapi-products">List all products</h2>

<p>
</p>

<p>Returns a paginated list of products. Supports filtering by category and searching by text.</p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/products?category=notebooks&amp;search=pencil&amp;per_page=10&amp;page=1" \
    --header "Accept-Language: en" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="query">
    <br>
<p>Filter by category slug (e.g. 'notebooks'). Example: <code>notebooks</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>search</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="query">
    <br>
<p>Search name or description. Example: <code>pencil</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>per_page</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
...
<p>The page number. Example: <code>1</code></p>
                    ...
                    <h2 id="products-categories-public-GETapi-products--id-">Get product details</h2>
...
<p>The ID of the product. Example: <code>1</code></p>
                ...
                <h1 id="user-orders">User Orders</h1>
                                ...
                                <h2 id="user-orders-GETapi-orders">List my orders</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/orders?per_page=10&amp;page=1" \
    --header "Authorization: Bearer {YOUR_AUTH_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<p>The page number. Example: <code>1</code></p>
                    ...
                    <h2 id="user-orders-POSTapi-orders">Create a new order (Checkout)</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Validates products, calculates totals on the server, and creates the order.</p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="payment_method_id"                data-endpoint="POSTapi-orders"
               value="1"
               data-component="body">
    <br>
<p>ID of the payment method (e.g. 1 for COD). Example: <code>1</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
        <details>
            <summary style="padding-bottom: 10px;">
...
<small>string[]</small>&nbsp;
 ...
 &nbsp;
<br>
<p>Array of products to purchase.</p>
            </summary>
                                                <div style="margin-left: 14px; clear: unset;">
                        <b style="line-height: 2;"><code>product_id</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
